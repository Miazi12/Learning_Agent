...
ব্যবহারকারী YouTube link বা ভিডিও/অডিও ফাইল bot-কে পাঠালে,
bot সেটা প্রসেস করে বাংলায় সামারি + ওয়ার্কফ্লো + প্রবলেম-সলিউশন রিপ্লাই করে।
"""
...
async def _run_blocking(func, *args, **kwargs):
    """blocking (CPU/IO heavy) ফাংশনগুলো আলাদা থ্রেডে চালায়, যাতে bot ফ্রিজ না হয়"""
